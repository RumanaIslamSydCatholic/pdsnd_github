...
def get_filters():
    ...
    while True:
        month = input("Please enter a month name from Jan-Jun or all for all months (all, january, february, ... , june): ")
        month = month.lower()
...
def user_stats(df):
    ...
    try:
        ...
        print('No gender data available for the city selected')
